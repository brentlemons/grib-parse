...
var readSection0 = function(buf) {
  ...
  section['discipline'] = buf.readUInt8(6);
  section['edition'] = buf.readUInt8(7);
  section['total_length'] = (buf.readUInt32BE(8) << 8) + buf.readUInt32BE(12);
  return section;
};
...
var readSection3 = function(buf) {
  ...
  section['length'] = buf.readUInt32BE(0);
  section['id'] = buf.readUInt8(4);
  section['definition_source'] = buf.readUInt8(5);
  section['data_points'] = buf.readUInt32BE(6);
  section['optional_list_length'] = buf.readUInt8(10);
  section['stuff'] = buf.readUInt8(11);
  section['template_number'] = buf.readUInt16BE(12);
//  section[''] = buf.readUInt8(5);
...
module.exports.parse = function (filename) {
  ...
  buf = buf.slice(section_1.length);

  section_3 = readSection3(buf);
  length_remaining -= section_3.length;
  console.log('section 3: ');
  console.log(section_3);
  buf = buf.slice(section_3.length);
