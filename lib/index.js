...
module.exports.parse = function (filename) {
  ...
  var section1_month = contents.readUInt8(69);
  var section1_day = contents.readUInt8(70);
  var section1_hour = contents.readUInt8(71);
  var section1_minute = contents.readUInt8(72);
  var section1_second = contents.readUInt8(73);
